...
const showBalance = (person) => console.log(`owener: ${person.name}, balance: ${person.describe()}`); 
accounts.forEach(person => showBalance(person));
accounts.forEach(person => person.credit(1000));
accounts.forEach(person => showBalance(person));
